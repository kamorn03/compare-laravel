...
@section('content')
    <div class="col-12">
        ...
        <span class="float-right">
            <a href="{{ route('admin.category.add') }}"><i class="fa fa-plus"></i> เพิ่มประเภทสินค้า </a>
        </span>
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            return '<a href="/digiso-admin/category/' + row.id + '/edit"><i class="fa fa-pencil" data-id="' + row.id + '"></i></a>'
                        }
                    },
                    {
                        data: null,
                        ...
                        render: function(data, type, row) {
                            return '<a href="/digiso-admin/category/' + row.id + '/delete"><i class="fa fa-trash" data-id="' + row.id + '"></i></a>'
                        }
                    }
                ]
            });
